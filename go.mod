...
require (
	github.com/go-micro/microwire-plugins/broker/http/v5 v5.2.0
	...
	github.com/go-micro/microwire-plugins/transport/http/v5 v5.1.1
	github.com/go-micro/microwire-plugins/transport/quic/v5 v5.1.2
...
require (
	...
	github.com/go-micro/microwire-plugins/codec/grpc/v5 v5.1.0 // indirect
	github.com/go-micro/microwire-plugins/codec/jsonrpc/v5 v5.0.0 // indirect
	github.com/go-micro/microwire-plugins/codec/proto/v5 v5.1.0 // indirect
	github.com/go-micro/microwire-plugins/codec/protorpc/v5 v5.1.0 // indirect
	...
	github.com/go-micro/microwire-plugins/events/natsjs/v5 v5.2.0 // indirect
